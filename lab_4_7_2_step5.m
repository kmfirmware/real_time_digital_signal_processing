...
subplot(321),plot(f(range836hz),magFFT_in(range836hz),'r'), title('Input 800 Hz'),xlabel('f(Hz)')
subplot(322),plot(f(range836hz),magFFT_out(range836hz)), title('Output 800 Hz'),xlabel('f(Hz)')
subplot(323),plot(f(range1200hz),magFFT_in(range1200hz), 'r'), title('Input 1200 Hz'),xlabel('f(Hz)')
subplot(324),plot(f(range1200hz),magFFT_out(range1200hz),'r'), title('Output 1200 Hz'),xlabel('f(Hz)')
