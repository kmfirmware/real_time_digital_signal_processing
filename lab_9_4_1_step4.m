...
[b,fs]=audioread('Silent.wav',[frame*(frame_sel-1)+1,frame*frame_sel],'native');
%fs=8000;                      % Sampling frequency 
lpcOrder=12;                  % LPC order
...
figure('Name',strcat('Silent.wav LPC order ',num2str(lpcOrder)),'NumberTitle','off');
